...
Новая ветка создаётся с помощью команды *git branch <название ветки>*. Для перемещения между ветками используется команда *git checkout < имя ветки>*.
...
Для удаления ветки которая не была слита используется команда *git branch -D <название ветки>*
