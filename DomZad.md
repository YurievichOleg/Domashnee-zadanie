...
## Журнал изменений
Просмотреть журнал изменений можно с помощью команды *git log*. При вводе команды будут продемонстрированны все коммиты, с указанием их номера, названия, тем кто осуществлял изменения.
